      ...
      <div className='letter'>
        ...
        {isShow ? (
          <div className='content long-content'>
            <p>世の中には、自分が変わることなくお金だけが欲しいという人が多い。お金を増やしたかったのに失ってしまうというカラクリは、知識のないまま無茶な取引をしてしまうことだけでなく、「簡単に儲かる」と謳って高額キックバックのある商材に誘導するというマネー業界の悪しき習慣も関係する。 退職金などまとまったお金を持った人を狙った詐欺も多い。でもそんなことをしていては、信用は築けない。</p>
