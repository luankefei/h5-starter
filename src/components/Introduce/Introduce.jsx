...
const list = [
  ...
  },
  {
    name: '木村 達也 副センター長',
    image: people3,
    introduce: '<p>20年以上ウォール街の大手投資ファンド、証券会社などの実務経験を積み上げてきた東京に在住、シンガーポール出身の元ファンドマネジャー、現在Parkway金融投資機関のファイナンス.アドバイザーとして活躍、株や為替投資、資産運用のコンサルティング業務を努める。</p>'
  },
  {
    name: '林 孝雄 チーフアドバイザー',
    image: people8,
  ...
  {
    name: 'ALEX LEE チーフアナリスト',
    image: people4,
    introduce: '<p>日本の名門私立大学大学院卒業。</p><p>大手証券会社に入社した後、金融界の華やかさを知って退職を決意し、メガバンクの海外支店に転職。グローバルプラットフォームで外国為替市場と資金調達に専念で専門知識と実戦経験を身につけた。</p><p>今ではParkway金融研究センターのチーフアナリストとして、投資グループから一般の方まで幅広く、資産運用、バリュー投資のコンサルティング業務に専念している。</p>'
  },
  {
    name: 'KONAN KANEKO チーフアドバイザー',
    image: people7,
    introduce: '<p>1995年埼玉県草加市生まれ。</p><p>2015年親元を離れ海外留学を決める。</p><p>中国の名門私立大学大学院卒業。在学中・フリーランスとして働く後輩との、ご縁をきっかけに勤めること以外の働き方を知り独立を決意。</p><p>持ち前のコミュニケーションスキルを活かし、在学中に日中交流会やユース経営者サロンを手がける。卒業後【中国マーケの会社を経営｜工場投資｜D2Cブランドの商品開発コンサル】</p><p>2020年にコロナの影響を受け【金融業界】へ本腰を入れる。金融業界で若手ながらも個人法人問わず、年間300名以上の個別相談に対応。</p><p>現在は自分の会社も経営しながら・ファイナンシャルアドバイザーとして一般の方から経営者まで幅広く・資産形成、トレードのコンサルタント業務を行なっている。</p>'
  },
  {
    name: 'マイケル 首席研究員',
    image: people9,
    introduce: '<p>1日本の大学院でIT知識を学び、富士通に入社。その後、豪州に移民、投資ファンドに転職。</p><p>為替取引と株式市場に専念し、専門知識や実践経験を積み重ね、自分なりの投資手法で活躍している。</p><p>現在ではParkway金融研究センターの研究員として、バリュー投資のコンサルティングサービスを担当している。</p><p>逆張り＋押し目買いの投資手法にご興味のある方はぜひ時間を作って話しましょう。</p>'
  },
  {
    name: 'フルヤ チーフアナリスト',
    image: people6,
    introduce: '<p>1992年台湾生まれ。日本の名門私立大学慶應義塾経済学部卒業。</p><p>大手証券会社に入社した後、アカウントマネージャーを担当し、一年後、投資顧問業者へ昇進。認識の広がりにつき、金融界に無限の可能性があると、退職を決意し。グローバルの視点から考え、より先進な金融サービスを日本に引いれることに痛感。</p><p>グローバルプラットフォームで通貨ペア、株、商品CFD、仮想通貨に専念、テクニカル分析得意。</p><p>グローバルプラットフォームで通貨ペア、株、商品CFD、仮想通貨に専念、テクニカル分析得意。</p>'
  },
  {
    name: 'Louisa Chan チーフアドバイザー',
    image: people2,
    introduce: '<p>Louisa  Chan  チーフアドバイザー</p><p>GEMアセットマネジメントプテリミテッドで7年間、ファンドマネージャーとして豊富なファンド運用およびアセットマネジメントの経験を積み重ねた。2019年に日本の大手証券会社に入社し、海外市場ビジネスディレクターとして、大量な米国株投資、為替投資、ゴールド投資の実務経験をした。</p><p>現在はParkway金融研究センターのチーフアドバイザーとして、投資家教育、資産管理とバリュー投資に専念している。</p>'
  },
  {
    name: '稲垣 雅広 チーフアドバイザー',
    image: people1,
    introduce: '<p>1974年香港生まれ。日本の経営学部を卒業。香港大学で金融学の修士を取得。</p><p>学術的な基礎を確立した後、25年間も銀行や証券他金融業界に身を投じ、多岐にわたる専門並びに管理経験を積むことができました。</p><p>現在、Parkway金融研究センターでアジア太平洋地域の投資責任者として活躍しています。</p><p>同センターの優れたリサーチ力を基に、国･地域の金融政策や経済状況をしっかり把握しテクニカル分析を活用した上の株･FX･ゴールドの高勝率トレードが堪能です。</p><p>同センターの優れたリサーチ力を基に、国･地域の金融政策や経済状況をしっかり把握しテクニカル分析を活用した上の株･FX･ゴールドの高勝率トレードが堪能です。</p>'
  }
]
function Introduce() {
          ...
          {list.map((item, index) => (
            <SwiperSlide key={item.name}>
              <dl>
                ...
                <dd dangerouslySetInnerHTML={{__html: item.introduce}}></dd>
              </dl>
            </SwiperSlide>
          ))}
        </Swiper>
