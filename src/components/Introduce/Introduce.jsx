...
const list = [
  ...
  {
    name: "KONAN KANEKO",
    appointment: "KONAN KANEKO チーフアドバイザー",
    image: people7,
    introduce:
  ...
  {
    name: "マイケル",
    appointment: "マイケル 首席研究員",
    image: people9,
    introduce:
      "<p>1日本の大学院でIT知識を学び、富士通に入社。その後、豪州に移民、投資ファンドに転職。</p><p>為替取引と株式市場に専念し、専門知識や実践経験を積み重ね、自分なりの投資手法で活躍している。</p><p>現在ではParkway金融研究センターの研究員として、バリュー投資のコンサルティングサービスを担当している。</p><p>逆張り＋押し目買いの投資手法にご興味のある方はぜひ時間を作って話しましょう。</p>",
  },
  {
    name: "フルヤ",
    appointment: "フルヤ チーフアナリスト",
    image: people6,
    introduce:
      "<p>1992年台湾生まれ。日本の名門私立大学慶應義塾経済学部卒業。</p><p>大手証券会社に入社した後、アカウントマネージャーを担当し、一年後、投資顧問業者へ昇進。認識の広がりにつき、金融界に無限の可能性があると、退職を決意し。グローバルの視点から考え、より先進な金融サービスを日本に引いれることに痛感。</p><p>グローバルプラットフォームで通貨ペア、株、商品CFD、仮想通貨に専念、テクニカル分析得意。</p><p>グローバルプラットフォームで通貨ペア、株、商品CFD、仮想通貨に専念、テクニカル分析得意。</p>",
  },
  {
    name: "Louisa Chan",
    appointment: "Louisa Chan チーフアドバイザー",
    image: people2,
    introduce:
      "<p>Louisa  Chan  チーフアドバイザー</p><p>GEMアセットマネジメントプテリミテッドで7年間、ファンドマネージャーとして豊富なファンド運用およびアセットマネジメントの経験を積み重ねた。2019年に日本の大手証券会社に入社し、海外市場ビジネスディレクターとして、大量な米国株投資、為替投資、ゴールド投資の実務経験をした。</p><p>現在はParkway金融研究センターのチーフアドバイザーとして、投資家教育、資産管理とバリュー投資に専念している。</p>",
  },
  {
    name: "稲垣 雅広",
    appointment: "稲垣 雅広 チーフアドバイザー",
    image: people1,
    introduce:
          ...
          {list.map((item, index) => (
            <SwiperSlide key={item.name}>
              <dl>
                ...
                <dd>
                  <div className="appointment">{item.appointment}</div>
